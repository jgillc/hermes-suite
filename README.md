...
podman build \
  ...
  --build-arg HERMES_WEBUI_VERSION=v0.51.30 \
...
./build.sh
# Override defaults:
# ./build.sh --agent v2026.5.7 --webui v0.51.30
```
...
| `2026.5.7-0.51.30` | v2026.5.7 | v0.51.30 | amd64 + arm64 |
...
- **WebUI**: semantic version from `nesquena/hermes-webui` (e.g. `v0.51.30`)
